...
<form:form method="POST" modelAttribute="objUser" data-toggle="validator" role="form">
    ...
    <div class="form-group">
        ...
        <form:input  id="inputName" path="contact.name" type="text" class="form-control rounded" placeholder="Ваше имя"/>
    ...
    <div class="form-group">
        ...
        <form:input id="inputBirthday" data-date-format="DD.MM.YYYY" path="contact.birthday" value="${objUser.contact.birthday}" type="Date" class="form-control rounded" placeholder="Ваш день рождения"/>
        <div class="help-block with-errors">
    ...
    <div class="form-group">
        ...
        <form:input id="inputPhone" path="contact.phone" type="text" class="form-control rounded" placeholder="+7-900-123-45-67"/>
        <div class="help-block with-errors">
